    ...
    <div class="custom-wrapper color-green" style="width: 100%">
            <div class="container">
                <div class="newsletter_wrapper text-center">
                    <h3 style="margin-left: -560px">Post Feedback</h3>
                    <div class="row" style="width:100%; align:center;  margin-left: 184px;">
                        <form id="loginform" method="post" action="<%=request.getContextPath()%>/FeedbackController">
                            ...
                            <div class="clearfix" style="height: 100%;"></div><br>
                            <div style="margin-right: 800px;">
                            <input type="hidden" name="flag" value="insert">
                            <button class="btn btn-default btn-lg border-radius" style="margin-left: -147px;" type="submit">Submit</button>
                            </div>    
                        </form>
                    </div>
