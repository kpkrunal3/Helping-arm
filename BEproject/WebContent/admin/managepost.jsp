                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <tr>
								...
								<td>
                                   <a href="<%=request.getContextPath()%>/PostController?flag=delete&id=${i.postId}">Delete</a>/<a href="<%=request.getContextPath()%>/PostController?flag=edit&id=${i.postId}">Edit</a>
                                </td>
