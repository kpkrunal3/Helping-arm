                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class=" form">
                                    <form class="cmxform form-horizontal tasi-form"  method="post" action="<%=request.getContextPath()%>/PostController">
                                        <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
											<c:forEach items="${sessionScope.postList}" var="i">
                                        <div class="form-group ">
                                            <label for="cname" class="control-label col-lg-2">PostName*</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="cname" name="pname" minlength="2" value="${i.postName}" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
