                            ...
                            <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                            	<c:forEach items="${sessionScope.state}" var="i">
                            	 <tr>
										...
										<td>
		                                   <a href="<%=request.getContextPath()%>/StateController?flag=delete&id=${i.stateId}">Delete</a>/<a href="<%=request.getContextPath()%>/StateController?flag=edit&id=${i.stateId}">Edit</a>
		                                </td>
		                          </tr>
                                </c:forEach>
