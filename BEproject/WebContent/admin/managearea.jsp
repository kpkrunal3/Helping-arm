                    ...
                    <div class="col-sm-12">
                        <section class="panel">
							...
							<tr>
								...
								<td>
                                    <a href="<%=request.getContextPath()%>/AreaController?flag=delete&id=${i.areaId}">Delete</a>/<a href="<%=request.getContextPath()%>/AreaController?flag=edit&id=${i.areaId}">Edit</a>
                                </td>
