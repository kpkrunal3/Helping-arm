                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <tr>
								...
								<td>
                                    <a href="<%=request.getContextPath()%>/CityController?flag=delete&id=${i.cityId}">Delete</a>/<a href="<%=request.getContextPath()%>/CityController?flag=edit&id=${i.cityId}">Edit</a>
                                </td>
