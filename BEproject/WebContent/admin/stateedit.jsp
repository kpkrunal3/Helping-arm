                            ...
                            <div class="panel-body">
                                <div class=" form">
                                 <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
                                    ...
                                    <form class="cmxform form-horizontal tasi-form"  method="post" action="<%=request.getContextPath()%>/StateController">
									<div class="form-group ">
                                            <label for="cname" class="control-label col-lg-2">State Name*</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="cname" name="sname" value="${i.stateName}"minlength="2" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="cname" class="control-label col-lg-2">Description*</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="cname" name="des" value="${i.stateDescription}"minlength="2" type="text" required />
                                            </div>
                                        </div>
                                    <input type="hidden" name="id" value="${i.stateId}">    
